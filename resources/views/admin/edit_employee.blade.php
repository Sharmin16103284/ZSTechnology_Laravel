                           ...
                           @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="name" type="text" class="form-control" id="fname" value="{{$edits->name}}">
                                        </div>
                                    </div>
                                ...
                                @endforeach
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="nid" type="number" class="form-control" id="nid" value="{{$edits->nid}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="address" type="text" class="form-control" id="address" value="{{$edits->address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="blood_group" type="text" class="form-control" id="blood_group" value="{{$edits->blood_group}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="number" type="number" class="form-control" id="number" value="{{$edits->number}}">
										</div>
                                    </div>
									<div class="form-group row">
