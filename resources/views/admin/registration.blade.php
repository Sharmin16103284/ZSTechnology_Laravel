                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                            	<div class="input-group mb-3">
                                    ...
                                    <input name="name" type="tnameext" class="form-control form-control-lg" placeholder="User Name" required>
                                </div>
                                <!-- email -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button name="register" class="btn btn-block btn-lg btn-info" type="submit">Sign Up</button>
                                    </div>
                                </div>
                            </div>
                        </div>
